...
![develop failed](images/django2.png)
...
![setup.py fix](images/my-fix.png)
...
![Older Django being downloaded](images/django-v-fixed.png)

![Successful!](images/Success!.png)
...
![Server Up and Running!](images/up-and-running.png)
