...
![Screenshot of Lubntu](images/linux.png)
...
## 2. git and GitHub
![Pushing commits using git](images/git.png)
...
## 3. Virtual Machines
![VirtualBox running Ubuntu Server 14.04](images/virtualbox.png)
...
## 4. Python
![virtualenv Creation using Python](images/virtualenv.png)
...
## 5. Web Programming
![The first site I created using Django](images/website.png)
...
## 6. CSS & HTML
![Inspecting the site](images/css-html.png)
...
![A basic .yml file](images/yaml.png)
...
## 8. Markdown
![A basic MarkDown example](images/markdown.png)
...
![RESTful API](images/restful-api.jpg)
